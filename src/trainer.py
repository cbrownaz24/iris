...
class Trainer:
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self.optimizer_world_model = configure_optimizer(self.agent.world_model, cfg.training.learning_rate, cfg.training.world_model.weight_decay, stu_lr=cfg.training.world_model.stu_lr)
    ...
    def inspect_imagination(self, epoch: int) -> None:
        ...
        for i, (o, a, r, d) in enumerate(zip(outputs.observations.cpu(), outputs.actions.cpu(), outputs.rewards.cpu(), outputs.ends.long().cpu())):  # Make everything (N, T, ...) instead of (T, N, ...)
            ...
            if self.cfg.common.do_checkpoint:
